...
const advantagesData: AdvantageItem[] = [
    {
        ...
        description: 'Мотоциклы KAYO собираются на современном оборудовании из высококачественных материалов и комплектующих.',
        icon: 'quality'
    },
    {
        id: '2',
        title: 'Доступные цены',
        description: 'Мы предлагаем лучшее соотношение цены и качества на рынке мототехники.',
        icon: 'price'
    },
    {
        id: '3',
        title: 'Широкий выбор моделей',
        description: 'В линейке KAYO представлены мотоциклы для любых задач и условий эксплуатации.',
        icon: 'variety'
    }
];
