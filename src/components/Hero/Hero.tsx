    ...
    <HeroSection id="home">
      <div className="container">
        <HeroContainer>
          <HeroContent>
            <HeroTitle>
              Получить предложения <span>с актуальными ценами</span>
            </HeroTitle>
            <HeroSubtitle>
              Мотоциклы KAYO - премиальное качество по доступной цене. Выбери свой идеальный мотоцикл для любых условий.
            </HeroSubtitle>
            <ButtonGroup>
              <WhatsAppButton href="https://wa.me/79203083324?text=Здравствуйте,%20можете%20предоставить%20актуальный%20каталог">
          ...
          <HeroImageWrapper>
            <img src="/placeholder-motorcycle.webp" alt="Мотоцикл KAYO" />
          </HeroImageWrapper>
        </HeroContainer>
      </div>
    </HeroSection>
