    ...
    <HeroSection id="home">
      <div className="container">
        <HeroContainer>
          <HeroContent>
            <HeroTitle>
              Мотоциклы <span>Kawasaki</span> - легендарное качество
            </HeroTitle>
            <HeroSubtitle>
              Kawasaki - это более 100 лет инноваций и страсти к мотоциклам. Выберите свой идеальный мотоцикл из линейки легендарного японского бренда.
            </HeroSubtitle>
            <ButtonGroup>
              <WhatsAppButton href="https://wa.me/79203383324?text=Здравствуйте,%20интересует%20каталог%20мотоциклов%20Kawasaki" target="_blank" rel="noopener noreferrer">
